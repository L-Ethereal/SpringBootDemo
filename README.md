...
~~就不卖关子了，图片转字符可以上这个[传送门](http://ku.cndesign.com/pic/)，白底的话会按空格补全，否则都为字符。~~

前面的传送门貌似出了点问题，下面再补上个[新的传送门](http://www.makepic.net/Tool/Image2ascii.html)，也是很好用的，可以选择质量。

这不，下面的两只doge和一头滑稽就是产自于它，have fun，快去制作专属的字符注释吧。

再补上一个好玩的网站[Ascii World](http://www.asciiworld.com/)，由于这网站的图形太多了，我就不贴上来了。
